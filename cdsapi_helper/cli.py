...
def download_cds(
    ...
    # Collect request entries generated by input spec file
    request_entries = []
    ...
    click.echo(
        f"{len(request_entries)} request(s) generated by specification.", err=True
    )
    ...
    send_request(dataset, remaining_requests, dry_run)
